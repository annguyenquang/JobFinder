...
namespace JobFinder.Migrations
{
    ...
    [Migration("20241023140700_RenameTablePositionToJob")]
    partial class RenameTablePositionToJob
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JobFinder.Core.Entity.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e291b60a-2f72-42c1-ad22-cba5364b1446"),
                            Email = "",
                            Password = "admin",
                            Phone = "113",
                            Username = "admin"
                        ...
                        new
                        {
                            Id = new Guid("76846414-036b-4892-8093-15c46d101333"),
                            Email = "",
                            Password = "account0",
                            Phone = "0123456789",
                            Username = "account0"
                        ...
                        new
                        {
                            Id = new Guid("d8b16970-bad3-4856-ac4b-5d3c342b759d"),
                            Email = "",
                            Password = "account1",
                            Phone = "0823456789",
                            Username = "account1"
                        ...
                        new
                        {
                            Id = new Guid("222d5289-21ea-41ca-a6cf-026b54642cc3"),
                            Email = "",
                            Password = "account2",
                            Phone = "0183456789",
                            Username = "account2"
                        ...
                        new
                        {
                            Id = new Guid("b9bb9c4e-86ba-415e-8e37-10b46d1dc836"),
                            Email = "",
                            Password = "account3",
                            Phone = "0128456789",
                            Username = "account3"
                        ...
                        new
                        {
                            Id = new Guid("5925f5cd-2c71-4b62-a212-fb6a1c5111a6"),
                            Email = "",
                            Password = "account4",
                            Phone = "0123856789",
                            Username = "account4"
            ...
            modelBuilder.Entity("JobFinder.Core.Entity.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2a13fe71-f3b5-4f40-b9ac-69e207365ab9"),
                            AccountId = new Guid("e291b60a-2f72-42c1-ad22-cba5364b1446"),
                        ...
                        new
                        {
                            Id = new Guid("37f6c5c7-6380-43f6-a66f-6a64379910b3"),
                            AccountId = new Guid("76846414-036b-4892-8093-15c46d101333"),
                        ...
                        new
                        {
                            Id = new Guid("1b93b95c-8203-4105-9ab1-f0fa303ef2ad"),
                            AccountId = new Guid("d8b16970-bad3-4856-ac4b-5d3c342b759d"),
            ...
            modelBuilder.Entity("JobFinder.Core.Entity.Job", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4de4f55b-db6f-4789-a182-01e7e3402367"),
                            CloseDate = new DateTime(2025, 1, 23, 21, 6, 59, 524, DateTimeKind.Local).AddTicks(7477),
                            CommitmentTypeId = new Guid("540f318e-b42f-4485-9e60-8faa5bf80962"),
                            CompanyId = new Guid("2a13fe71-f3b5-4f40-b9ac-69e207365ab9"),
                            CreatedAt = new DateTime(2024, 10, 23, 21, 6, 59, 524, DateTimeKind.Local).AddTicks(7507),
                            ...
                            UpdatedAt = new DateTime(2024, 10, 23, 21, 6, 59, 524, DateTimeKind.Local).AddTicks(7508),
                        ...
                        new
                        {
                            Id = new Guid("01075104-9a8b-4ddc-9285-7f9dd88707d3"),
                            CloseDate = new DateTime(2024, 12, 23, 21, 6, 59, 524, DateTimeKind.Local).AddTicks(7512),
                            CommitmentTypeId = new Guid("5d06c3b1-2bd1-4c68-96b4-f4cd8c899dff"),
                            CompanyId = new Guid("37f6c5c7-6380-43f6-a66f-6a64379910b3"),
                            CreatedAt = new DateTime(2024, 10, 23, 21, 6, 59, 524, DateTimeKind.Local).AddTicks(7519),
                            ...
                            Status = 1,
                            Title = "Data Analyst",
                            UpdatedAt = new DateTime(2024, 10, 23, 21, 6, 59, 524, DateTimeKind.Local).AddTicks(7520),
                        ...
                        new
                        {
                            Id = new Guid("67b425cb-39ab-4bfe-b222-b76430064590"),
                            CloseDate = new DateTime(2025, 2, 23, 21, 6, 59, 524, DateTimeKind.Local).AddTicks(7523),
                            CommitmentTypeId = new Guid("540f318e-b42f-4485-9e60-8faa5bf80962"),
                            CompanyId = new Guid("1b93b95c-8203-4105-9ab1-f0fa303ef2ad"),
                            CreatedAt = new DateTime(2024, 10, 23, 21, 6, 59, 524, DateTimeKind.Local).AddTicks(7528),
                            ...
                            UpdatedAt = new DateTime(2024, 10, 23, 21, 6, 59, 524, DateTimeKind.Local).AddTicks(7528),
                        ...
                        new
                        {
                            Id = new Guid("d802b669-34bf-4b9d-9163-c955fc827729"),
                            CloseDate = new DateTime(2025, 1, 23, 21, 6, 59, 524, DateTimeKind.Local).AddTicks(7531),
                            CommitmentTypeId = new Guid("44b668b2-09ee-499e-af95-73598f9153a2"),
                            CompanyId = new Guid("2a13fe71-f3b5-4f40-b9ac-69e207365ab9"),
                            CreatedAt = new DateTime(2024, 10, 23, 21, 6, 59, 524, DateTimeKind.Local).AddTicks(7536),
                            ...
                            Status = 1,
                            Title = "UX Designer",
                            UpdatedAt = new DateTime(2024, 10, 23, 21, 6, 59, 524, DateTimeKind.Local).AddTicks(7536),
                            WorkArrangementId = new Guid("04a9de34-0869-41b2-87a8-63c20c4ba22a"),
