...
namespace JobFinder.Migrations
{
    ...
    [Migration("20241027092738_UpdateAccountSeedData")]
    partial class UpdateAccountSeedData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JobFinder.Core.Entity.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f45d7725-3bf9-4cf2-9708-145c14eee7ee"),
                            Email = "",
                            Password = "$2a$11$f8Qkea/64xg9mMpMdh6a8.yb4KVnUOwT/XnidIojqBqR0G.SG7OOK",
                            Phone = "113",
                            Username = "admin"
                        },
                        new
                        {
                            Id = new Guid("2eaeeb0c-f11f-4e70-97c4-e7d7c70a4989"),
                            Email = "",
                            Password = "$2a$11$LT1iJJ69oAe2VIBQ7W6aTuqqXP3zPKajn.wvLBAufynpCNaVGlijC",
                            Phone = "0123456789",
                            Username = "account0"
                        },
                        new
                        {
                            Id = new Guid("23c255a5-eaf9-44aa-8daf-86d4d429960d"),
                            Email = "",
                            Password = "$2a$11$o6UUGpvEaYRml6ihRbv/nOmiijHsXXLEaNELpuxrbB5JdsuH.7p1e",
                            Phone = "0823456789",
                            Username = "account1"
                        },
                        new
                        {
                            Id = new Guid("65e2187f-eacf-4f46-beb0-902bcfae95b2"),
                            Email = "",
                            Password = "$2a$11$bIu0djWFoQBmo5VSR0d8Keo.VwZKjOu4NVa0U4VNINMDCPdzpVdKG",
                            Phone = "0183456789",
                            Username = "account2"
                        },
                        new
                        {
                            Id = new Guid("045b336c-4c6b-4d6e-8a5e-754410415630"),
                            Email = "",
                            Password = "$2a$11$BACDPGJyB8L6W00C9bzLx.7G/AM2TucN7HfrPPcEM0Td35.f/B9XW",
                            Phone = "0128456789",
                            Username = "account3"
                        },
                        new
                        {
                            Id = new Guid("2331de86-e1c1-48c1-9517-a43f5e651fdb"),
                            Email = "",
                            Password = "$2a$11$Q3mmWrF0iXG5V.2VG5jpTug3pE0kREjnM45yiH2QFYtpH8WeVtb/6",
                            Phone = "0123856789",
                            Username = "account4"
                        });
                });
            ...
            modelBuilder.Entity("JobFinder.Core.Entity.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c2c0df4d-ff19-4548-bcab-a5aa064bed4c"),
                            AccountId = new Guid("f45d7725-3bf9-4cf2-9708-145c14eee7ee"),
                        ...
                        new
                        {
                            Id = new Guid("3f7abc66-1336-4aa5-9d5f-57890a8a1b48"),
                            AccountId = new Guid("2eaeeb0c-f11f-4e70-97c4-e7d7c70a4989"),
                        ...
                        new
                        {
                            Id = new Guid("51537cfc-b358-44b5-81c9-f5e08245021e"),
                            AccountId = new Guid("23c255a5-eaf9-44aa-8daf-86d4d429960d"),
            ...
            modelBuilder.Entity("JobFinder.Core.Entity.Job", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("91b5757a-c767-4647-9ff5-4f4dd294d887"),
                            CloseDate = new DateTime(2025, 1, 27, 16, 27, 36, 762, DateTimeKind.Local).AddTicks(3224),
                            CommitmentTypeId = new Guid("540f318e-b42f-4485-9e60-8faa5bf80962"),
                            CompanyId = new Guid("c2c0df4d-ff19-4548-bcab-a5aa064bed4c"),
                            CreatedAt = new DateTime(2024, 10, 27, 16, 27, 36, 762, DateTimeKind.Local).AddTicks(3252),
                            ...
                            UpdatedAt = new DateTime(2024, 10, 27, 16, 27, 36, 762, DateTimeKind.Local).AddTicks(3253),
                        ...
                        new
                        {
                            Id = new Guid("00160ec7-7664-4e60-8a82-bec826c8b4b2"),
                            CloseDate = new DateTime(2024, 12, 27, 16, 27, 36, 762, DateTimeKind.Local).AddTicks(3257),
                            CommitmentTypeId = new Guid("5d06c3b1-2bd1-4c68-96b4-f4cd8c899dff"),
                            CompanyId = new Guid("3f7abc66-1336-4aa5-9d5f-57890a8a1b48"),
                            CreatedAt = new DateTime(2024, 10, 27, 16, 27, 36, 762, DateTimeKind.Local).AddTicks(3262),
                            ...
                            Status = 1,
                            Title = "Data Analyst",
                            UpdatedAt = new DateTime(2024, 10, 27, 16, 27, 36, 762, DateTimeKind.Local).AddTicks(3263),
                        ...
                        new
                        {
                            Id = new Guid("358879b5-b1db-4443-b38a-aaa71b0dff22"),
                            CloseDate = new DateTime(2025, 2, 27, 16, 27, 36, 762, DateTimeKind.Local).AddTicks(3266),
                            CommitmentTypeId = new Guid("540f318e-b42f-4485-9e60-8faa5bf80962"),
                            CompanyId = new Guid("51537cfc-b358-44b5-81c9-f5e08245021e"),
                            CreatedAt = new DateTime(2024, 10, 27, 16, 27, 36, 762, DateTimeKind.Local).AddTicks(3270),
                            ...
                            UpdatedAt = new DateTime(2024, 10, 27, 16, 27, 36, 762, DateTimeKind.Local).AddTicks(3271),
                        ...
                        new
                        {
                            Id = new Guid("6fb8fc0d-f3b8-4802-a54e-065e069f28e8"),
                            CloseDate = new DateTime(2025, 1, 27, 16, 27, 36, 762, DateTimeKind.Local).AddTicks(3273),
                            CommitmentTypeId = new Guid("44b668b2-09ee-499e-af95-73598f9153a2"),
                            CompanyId = new Guid("c2c0df4d-ff19-4548-bcab-a5aa064bed4c"),
                            CreatedAt = new DateTime(2024, 10, 27, 16, 27, 36, 762, DateTimeKind.Local).AddTicks(3278),
                            ...
                            Status = 1,
                            Title = "UX Designer",
                            UpdatedAt = new DateTime(2024, 10, 27, 16, 27, 36, 762, DateTimeKind.Local).AddTicks(3279),
                            WorkArrangementId = new Guid("04a9de34-0869-41b2-87a8-63c20c4ba22a"),
