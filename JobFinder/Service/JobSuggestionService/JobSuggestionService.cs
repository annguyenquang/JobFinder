...
{
    public JobSuggestionWithExplanation GetJobSuggestionWithExplanation(UserModel userProfile,
...
public record JobSuggestionWithExplanation
{
    ...
    public IEnumerable<JobSuggestionWithExplanation> Suggestions { get; init; } = new List<JobSuggestionWithExplanation>();
}
